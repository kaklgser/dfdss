      ...
      <div className="container-responsive py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200 dark:bg-dark-100 dark:border-dark-300 dark:shadow-dark-xl">
              <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 dark:bg-neon-cyan-500/20 dark:shadow-neon-cyan">
                <TrendingUp className="w-8 h-8 text-blue-600 dark:text-neon-cyan-400" />
              </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden dark:bg-dark-100 dark:border-dark-300 dark:shadow-dark-xl">
                <div className="bg-gradient-to-r from-green-50 to-blue-50 p-6 border-b border-gray-200 dark:from-dark-200 dark:to-dark-300 dark:border-dark-400">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mt-1">Add a job description for more targeted analysis</p>
                </div>
                <div className="p-6">
                  <textarea
                ...
                <div className="p-8">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                      ...
                      <div className="relative w-32 h-32 mx-auto mb-4">
                        <svg className="w-32 h-32 transform -rotate-90" viewBox="0 0 120 120">
                          ...
                          <circle
                            ...
                            strokeLinecap="round"
                            className={`${getScoreColor(scoreResult.totalScore)} dark:stroke-neon-cyan-400`}
                          />
                        </svg>
                    ...
                    <div className="md:col-span-2">
                      ...
                      <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">{scoreResult.analysis}</p>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="bg-green-50 p-4 rounded-lg border border-green-200 dark:bg-neon-cyan-500/10 dark:border-neon-cyan-400/50">
                          <h4 className="font-medium text-green-800 dark:text-neon-cyan-300 mb-2">Key Strengths</h4>
                        ...
                        <div className="bg-orange-50 p-4 rounded-lg border border-orange-200 dark:bg-orange-900/20 dark:border-orange-500/50">
                          <h4 className="font-medium text-orange-800 dark:text-orange-300 mb-2">Areas for Improvement</h4>
                  ...
                  {Object.entries(scoreResult.breakdown).map(([category, data]) => (
                    <div key={category} className="bg-gray-50 p-4 rounded-lg border border-gray-200 dark:bg-dark-200 dark:border-dark-300">
                      ...
                      <div className="flex items-center mb-2">
                        ...
                        <span className="text-gray-500 dark:text-gray-400">/{data.maxScore}</span>
                      </div>
                      <p className="text-sm text-gray-700 dark:text-gray-300">{data.details}</p>
                    </div>
                  ))}
                </div>
              </div>
