...
export const Tutorials: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 relative dark:from-dark-50 dark:to-dark-200 transition-colors duration-300">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">Video Tutorial</h2>
                <p className="text-xl text-gray-600 dark:text-gray-300">Learn how to use PrimoBoost AI to optimize your resume</p>
              </div>
                  ...
                  <div className="w-full h-0 pb-[56.25%] relative bg-gray-200 dark:bg-dark-200">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 font-medium">Click to play tutorial video</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      {/* Update Soon Overlay */}
      {showOverlay && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 dark:bg-black/70">
          <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full mx-auto text-center p-8 border border-gray-200 relative dark:bg-dark-100 dark:border-dark-300 dark:shadow-dark-xl">
            {/* Close Button */}
            <button 
            ...
            {/* Icon */}
            <div className="bg-gradient-to-br from-orange-100 to-yellow-100 w-20 h-20 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg dark:from-neon-cyan-500/20 dark:to-neon-blue-500/20 dark:shadow-neon-cyan">
              <Calendar className="w-10 h-10 text-orange-600 dark:text-neon-cyan-400" />
            </div>
            ...
            {/* Features List */}
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-4 mb-6 dark:from-dark-200 dark:to-dark-300">
              <div className="text-left space-y-2">
                <div className="flex items-center text-sm text-gray-700 dark:text-gray-300">
                  <CheckCircle className="w-4 h-4 text-green-500 dark:text-neon-cyan-400 mr-2 flex-shrink-0" />
            ...
            {/* Notification Button */}
            <button className="w-full bg-gradient-to-r from-orange-500 to-yellow-500 hover:from-orange-600 hover:to-yellow-600 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl transform hover:scale-105 mb-4 dark:from-neon-cyan-500 dark:to-neon-blue-500 dark:hover:from-neon-cyan-400 dark:hover:to-neon-blue-400 dark:shadow-neon-cyan">
            ...
            {/* Close hint */}
            <div className="mt-6 pt-4 border-t border-gray-100 dark:border-dark-300">
